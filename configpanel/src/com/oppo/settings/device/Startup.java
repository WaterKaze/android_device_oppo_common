...
import com.oppo.settings.device.utils.Constants;
import com.oppo.settings.device.utils.FileUtils;
...
public class Startup extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        } else if (intent.getAction().equals("android.intent.action.SCREEN_CAMERA_GESTURE")) {
    ...
    public static void toggleDoubleTap(Context context, IGestureService gestureService,
        ...
        if (enable) {
            Intent doubleTapIntent = new Intent("android.intent.action.SCREEN_CAMERA_GESTURE", null);
